...
public class User implements Serializable {
    ...
    @ApiModelProperty(value = "登录用户名", example = "scut")
    private String username;

    @ApiModelProperty(value = "真实姓名", example = "scut")
    ...
    @ApiModelProperty(value = "用户创建时间", example = "2024-10-22 10:35:44")
